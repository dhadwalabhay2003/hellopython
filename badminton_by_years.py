...
def print_results_by_game():
    ...
    if game == 1:
        for years in mens_singles_olympic_medals:
            print(f"{years['year']}: {years['location']}")
            print(f"Gold: {years['gold']['name']} - {years['gold']['country']}")
            print(f"Silver: {years['silver']['name']} - {years['silver']['country']}")
            print(f"Bronze: {years['bronze']['name']} - {years['bronze']['country']}\n")
    elif game == 2:
...
def check():
    ...
    silver = 0
    bronze = 0
    print('''U want to check the medals by:\n1. Location\n2. Name''')
    choice = int(input())
    if choice == 1:
    ...
    print(f"Gold: {list_of_medals[0]}, Silver: {list_of_medals[1]}, Bronze: {list_of_medals[2]}")
...
def check_by_year():
    ...
    choice2 = int(input())
    if choice2 == 1:
        list_of_medals = check_medals_by_year(year, mens_singles_olympic_medals)
    elif choice2 == 2:
        list_of_medals = check_medals_by_year(year, womens_singles_olympic_medals)
    elif choice2 == 3:
        list_of_medals = check_medals_by_year(year, mens_doubles_olympic_medals)
    elif choice2 == 4:
        list_of_medals = check_medals_by_year(year, womens_doubles_olympic_medals)
    elif choice2 == 5:
        list_of_medals = check_medals_by_year(year, mixed_doubles_olympic_medals)
    elif choice2 == 6:
        list_of_medals = check_medals_by_year(year, mens_singles_olympic_medals , womens_singles_olympic_medals ,
                                               mens_doubles_olympic_medals , womens_doubles_olympic_medals ,
                                               mixed_doubles_olympic_medals)
